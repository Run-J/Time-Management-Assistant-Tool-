...
//use iterate with manual stack
//while (current != NULL)  // find the button of the tree
//{
//	parent = current;
//	stack[top++] = current;
//
//	if (strcmp(current->dueDate, newAssign->dueDate) >= 0) 
//	{
...
//}
//
//// found right place and insert
//if (strcmp(parent->dueDate, newAssign->dueDate) >= 0) 
//{
//	parent->leftChild = newAssign;
//}
//else 
//{
//	parent->rightChild = newAssign;
//}
